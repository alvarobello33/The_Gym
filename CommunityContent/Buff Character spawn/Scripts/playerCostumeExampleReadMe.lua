--[[ 
		I built this MechSuit on top of riffraff's MultiplayerCostumeExample. I've left all the original 
	documentation in tact. Because of the geometry I've added, the default 3rd Person Camera settings 
	collide with the costume. Please experiment and find camera settings that work for you. 
	Meanwhile, I've used this:
	
	Third Person Camera
		FOV: 100
		Position Offset: x = 0, y = 100, z = -25
		Initial Distance: 350
		
	I hope you enjoy, and feel free to modify and use freely.
	-WitcherSilver
